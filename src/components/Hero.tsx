...
const Hero = () => {
  return (
    ...
    >
      ...
      <h2 className="uppercase tracking-wider text-gray-400">Web Developer</h2>
      ...
      <motion.div
        ...
        className="z-20 my-7 h-52 w-52 rounded-full bg-gray-900 md:h-64 md:w-64"
      >
        <Image
          src="/MeteorPic.png"
      ...
      <p className="text-md z-30 tracking-wider text-gray-200">
        Building modern web experiences and applications with modern tools.
      </p>
    </div>
  );
};
