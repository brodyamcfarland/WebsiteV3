    ...
    <div
      ...
      <div className="mx-5 mt-2 flex max-w-3xl flex-col items-center overflow-x-scroll border-t border-gray-600/75 bg-gradient-to-t from-blue-500/10 to-transparent p-10 pb-5 text-center shadow-inner scrollbar-thin scrollbar-track-white/10 scrollbar-thumb-white/50 md:mx-auto">
        <motion.div
            initial={{ x: 300 }}
            whileInView={{ x: 0 }}
            transition={{ type: "spring", stiffness: 75 }} className="flex items-center gap-5 pl-[32rem] md:pl-[10rem] lg:pl-[5rem]">
          <motion.div
            ...
            <p className="px-3 pt-2 pb-4 text-left text-xs text-gray-400">
              Crowdfunding Website built with NextJS, Typescript, Tailwind,
              Thirdweb, powered by Polygon (MATIC).
            </p>
          ...
          <motion.div
            ...
            <p className="px-3 pt-2 pb-4 text-left text-xs text-gray-400">
              Social Media website built with React, Tailwind, Firebase, Ethers
              JS, Solidity, and Typescript.
            </p>
            <div className="flex items-center justify-center gap-20 px-5">
              <Link
          ...
          <motion.div
            ...
            <p className="px-3 pt-2 pb-4 text-left text-xs text-gray-400">
              Online Shopping website built with NextJS, Typescript, Tailwind,
              Fakestore API, Next Auth, Stripe, React Redux, and Firebase.
            </p>
            <div className="flex items-center justify-center gap-20 px-5">
              <Link
