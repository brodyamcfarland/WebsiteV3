...
const SocialLinks = () => {
    return (
        <nav className="fixed top-2 left-[50%] z-50 flex -translate-x-1/2 scale-75 gap-16 border-gray-600 px-4 py-2 md:left-[94%] md:top-[25%] md:scale-100 md:flex-col md:gap-4 md:border-l md:border-t-0 md:px-2 md:py-4 xl:left-[80%]">
            <Link
